...
import {
  Container, Card, Text, Table, Badge, SimpleGrid,
  Group, Title, Button, ThemeIcon, Loader, Center
} from "@mantine/core";
  ...
  return (
    <Container size="lg" py="xl">
      <Group justify="space-between" mb="xl">
        <Title order={2} c="var(--text-clima-claro)">Meus Agendamentos</Title>
        <Button
          ...
          <Table.Tbody>
            {agendamentos.length > 0 ? (
              ...
              <Table.Tr>
                <Table.Td colSpan={4}>
                  <Center>
                    <Text c="dimmed">Você ainda não realizou nenhum agendamento.</Text>
                  </Center>
                </Table.Td>
              </Table.Tr>
            )}
