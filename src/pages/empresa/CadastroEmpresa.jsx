...
function CadastroEmpresa() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!response.ok) {
        setErro(data.message || "Erro ao cadastrar empresa.");
        return;
      }

      setSucesso("Empresa cadastrada com sucesso! Redirecionando para o login...");
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-200 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex min-h-[600px]">
        ...
        <div className="hidden md:block flex-1 relative">
          <img src={tecnico} alt="Técnico de climatização" className="w-full h-full object-cover" />
          ...
          <div className="absolute bottom-8 left-8 right-8">
            ...
            <p className="text-blue-200 text-sm mt-2">
              Cadastre sua empresa e configure seus serviços em minutos
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-10 md:px-12 overflow-y-auto">
          <div className="flex justify-center mb-6">
            <img src={logo} alt="Logo Mais Climatização" className="w-40 object-contain" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-sm mx-auto">
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text" name="name" placeholder="Ex: Mais Climatização"
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="email" name="email" placeholder="empresa@email.com"
            ...
            {sucesso && (
              <div className="bg-green-50 border border-green-200 text-green-700 text-sm px-4 py-3 rounded-xl">{sucesso}</div>
            )}
