...
const Navbar = () => {
  ...
  const handleMouseEnter = (e) => {
    // O indicador só funciona no desktop
    ...
    <section id="Nav">
      <nav>
        ...
        >
          ...
          <li><Link to="/agenda" onMouseEnter={handleMouseEnter} onClick={() => setIsOpen(false)}>Agendar</Link></li>
          <li><Link to="/dashboard" onMouseEnter={handleMouseEnter} onClick={() => setIsOpen(false)}>Meus Agendamentos</Link></li>
          <li><Link to="/configuracoes" onMouseEnter={handleMouseEnter} onClick={() => setIsOpen(false)}>Configurações</Link></li>
          <li><Link to="/sair" onMouseEnter={handleMouseEnter} onClick={() => setIsOpen(false)}>Sair</Link></li>
