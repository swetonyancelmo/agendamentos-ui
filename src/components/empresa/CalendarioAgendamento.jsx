...
const inputTime =
  "w-full bg-slate-50 border border-slate-200 text-slate-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition";
...
function CalendarioAgendamento() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-5">
      <div className="mb-8">
        <h1 className="text-xl font-bold text-slate-800">Gestão de Horários</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6">
          <h2 className="text-sm font-semibold uppercase tracking-widest text-slate-600 mb-5">
          ...
          <div className="grid grid-cols-7 gap-1 text-center mb-5">
            {["D", "S", "T", "Q", "Q", "S", "S"].map((d, i) => (
              <div key={i} className="text-xs text-slate-600 font-semibold py-1">{d}</div>
            ))}
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6">
          ...
          <div className="space-y-2 max-h-[400px] overflow-y-auto">
            {disponibilidades.length === 0 ? (
              <p className="text-sm text-slate-600 italic">Nenhuma disponibilidade cadastrada.</p>
            ) : (
              disponibilidades.map((d) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-slate-600 hover:text-red-500 p-1.5 rounded-lg hover:bg-red-50 transition-colors cursor-pointer"
                  >
